  ...
  return (
    <div className="flex flex-wrap gap-2 items-center max-w-full relative">
      ...
      {assignees && assignees.length > 0 ? (
        <div
          className="flex items-center gap-2 flex-wrap bg-white border rounded-lg shadow px-4 py-2 relative cursor-pointer"
        ...
        <div className="relative">
          <button
            className="border rounded px-4 py-2 text-sm font-medium hover:bg-blue-50 transition flex items-center gap-1"
            type="button"
            onClick={onMembersClick}
          >
