...
export const AssigneesSection: React.FC<AssigneesSectionProps> = ({ assignedUsers, onRemoveAssignee }) => {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap mb-4">
      <span className="text-sm font-semibold text-gray-700 mr-2">Assigned Members:</span>
