        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg transition-colors ${
                viewMode === "analytics" ? "bg-blue-600 text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"
              }`}
            >
              Analytics
            </button>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredTimeLogs.map((log) => (
                    <tr key={log._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-900">{new Date(log.date).toLocaleDateString()}</td>
                      <td className="px-6 py-4">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              ...
              <div className="space-y-4">
                {userStats.slice(0, 5).map((stat) => (
                  <div key={stat.user?._id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              ...
              <div className="space-y-4">
                {projectStats.slice(0, 5).map((stat) => (
                  <div key={stat.project?._id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div className="flex items-center gap-3">
                    ...
                    <div className="text-right">
                      <p className="font-medium text-gray-900">{formatHours(stat.hours)}</p>
                      <p className="text-sm text-gray-500">
                        {timeStats.totalHours > 0 ? ((stat.hours / timeStats.totalHours) * 100).toFixed(1) : "0.0"}%
                      </p>
                    </div>
                  </div>
                ))}
