...
const EmployeeSummaryPage: React.FC<SummaryPageProps> = ({ params }) => {
  ...
  const handleBackToTimeTracking = () => {
    router.push(`/employee-dashboard/productivity/clockify/${projectId}`);
  };

  const handleGoToCalendar = () => {
    router.push(`/employee-dashboard/productivity/clockify/${projectId}/calendar`);
  };
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-12">
            ...
            <button
              onClick={() => router.push("/employee-dashboard/productivity")}
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow">
          <TimeSummaryDashboard projectId={projectId} userId={session?.user?.id} />
        </div>
      </div>
    </div>
  );
