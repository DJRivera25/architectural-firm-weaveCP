    ...
    <section className="relative h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <motion.p
          ...
          className="text-xl sm:text-2xl text-blue-100 mb-8 max-w-2xl mx-auto"
        >
          We are a leading architectural firm specializing in innovative design solutions, sustainable architecture, and
